...
import useCategory from '@/recoil/category/useCategory';

export default function CategoryFilter({ keywords }: { keywords: TKeyword[] }) {
  const { showCategoryFilter, toggleShowCategoryFilter } = useCategory();
  ...
  return (
    <div className='mb-30 flex flex-col gap-10'>
      <button className='flex items-center gap-7' onClick={toggleShowCategoryFilter}>
